 ...
 *V1.1	|2/2018	|Minor changes in I/F to align with the Linux implementation
 */
#ifndef SERIALTXRX_H
#define SERIALTXRX_H
...
//specific to access Windows resources
#include <windows.h>
...
public:
	...
	void setPortParams(int baudRate, int timeout = 1);	//set port params in the current open port
