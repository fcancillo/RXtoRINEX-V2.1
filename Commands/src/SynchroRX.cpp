 ...
 *V1.2	|2/2018	|Adapted to new SerialTxRx I/F to set and get port parameters
 *				|Reviewed to run on Linux
 */
...
int main(int argc, char** argv) {
	...
	try {
		...
		if (currentMode==OSP && wantedMode==NMEA) {
			...
			this_thread::sleep_for (chrono::seconds(3));	//wait some seconds after changing receiver speed
